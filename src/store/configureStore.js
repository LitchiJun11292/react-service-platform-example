...
import {setUserLogin} from './actionCreators';
import base from './../utils/base';

const options = {
    sagaMonitor: {
        // rootSagaStarted: () => {
        //     console.log('runSaga或sagaMiddleware.run运行时调用此方法');
        // },
        // effectTriggered: () => {
        //     console.log('someEffect运行时调用此方法');
        // }
    }
};
...
// Add users information reducer
store.injectReducer('users', loginReducer);

// Add users information saga
store.injectSaga('users', loginSaga);

// User data request
if (base.getCookie('token')) {
